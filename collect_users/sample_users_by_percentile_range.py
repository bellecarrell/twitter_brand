...
from utils.sample_util import is_active
...
if __name__ == '__main__':
    ...
    sample_users_by_percentile, all_users_by_percentile = get_sample_users_by_percentile(user_json,
                                                                                         log_follower_percentiles,
                                                                                         percentile_max,
