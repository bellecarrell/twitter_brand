...
KEYS=(ac cr2 dl1 dl2 dl3 dl4 home t1 t2 t3 t4 t5);
ARTS=(designer poet rapper writer singer musician actor dancer freelance photographer journalist reporter);
